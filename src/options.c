...
#define MODOPT                                                              \
  "0:single,1:dgps,2:kinematic,3:static,4:movingbase,5:fixed,6:ppp-kine,7:" \
  "ppp-static,8:ppp-fixed"
#define FRQOPT "1:l1,2:l1+l2,3:l1+l2+l5,4:l1+l5"
#define TYPOPT "0:forward,1:backward,2:combined"
#define IONOPT                                                               \
  "0:off,1:brdc,2:sbas,3:dual-freq,4:est-stec,5:ionex-tec,6:qzs-brdc,7:qzs-" \
  "lex,8:stec"
...
#define TRCOPT                                                               \
  "0:off,1:err-msg,2:err-msg-datas,3:proc-msg,4:matrix,5:matrix-elements,6:" \
  "special data1,7:special data2"
#define STSOPT "0:off,1:state,2:residual"
#define ARMOPT                                                                 \
  "0:off,1:continuous,2:instantaneous,3:fix-and-hold,4:ppp-ar,5:ppp-ar-ils,6:" \
  "wide-lane-narrow-lane,7:triple-carrier-ar"
#define PPPAOPT "0:off,1:on"
#define PPPROPT "0:off,1:on"
...
EXPORT opt_t sysopts[] = {
    /* Second entry: option format (0:int,1:double,2:string,3:enum) */
    {"TimeStart-year", 1, (void *)&prcopt_.sTimeStart.Year, ""},
    {"TimeStart-month", 1, (void *)&prcopt_.sTimeStart.Month, ""},
    {"TimeStart-day", 1, (void *)&prcopt_.sTimeStart.Day, ""},
    {"TimeStart-hour", 1, (void *)&prcopt_.sTimeStart.Hour, ""},
    {"TimeStart-minute", 1, (void *)&prcopt_.sTimeStart.Minute, ""},
    {"TimeStart-second", 1, (void *)&prcopt_.sTimeStart.Second, ""},
    {"TimeEnd-year", 1, (void *)&prcopt_.sTimeEnd.Year, ""},
    {"TimeEnd-month", 1, (void *)&prcopt_.sTimeEnd.Month, ""},
    {"TimeEnd-day", 1, (void *)&prcopt_.sTimeEnd.Day, ""},
    {"TimeEnd-hour", 1, (void *)&prcopt_.sTimeEnd.Hour, ""},
    {"TimeEnd-minute", 1, (void *)&prcopt_.sTimeEnd.Minute, ""},
    {"TimeEnd-second", 1, (void *)&prcopt_.sTimeEnd.Second, ""},
    ...
    {"pos2-pppadpt", 3, (void *)&prcopt_.pppadpt, PPPAOPT},
    {"pos2-ppprbst", 3, (void *)&prcopt_.ppprbst, PPPROPT},
    ...
    {"out-trace", 3, (void *)&solopt_.trace, TRCOPT},
    ...
    {"out-outamb", 3, (void *)&solopt_.samb, STSOPT},
    {"out-outres", 3, (void *)&solopt_.sres, STSOPT},
    {"out-outazl", 3, (void *)&solopt_.sazl, STSOPT},
    {"out-outposmatpath", 2, (void *)&solopt_.outposmat, ""},
    ...
    {"stats-prnisb", 1, (void *)&prcopt_.prn[6], "m"},
    ...
    {"file-basefile", 2, (void *)&filopt_.basefile, ""},
    {"file-navfile", 2, (void *)&filopt_.navfile, ""},
    {"file-orbitfile", 2, (void *)&filopt_.orbitfile, ""},
    {"file-clkfile", 2, (void *)&filopt_.clkfile, ""},

    {"file-file_id", 2, (void *)&filopt_.file_id, ""},
    {"file-prc_id4opname", 2, (void *)&filopt_.prc_id4opname, ""},
    {"file-groundtruth", 2, (void *)&filopt_.groundtruth, ""},
    {"file-posfilepath", 2, (void *)&filopt_.pospath, ""},
    {"file-posfilepath", 2, (void *)&filopt_.pospathmat, ""},
    {"file-ambpath", 2, (void *)&filopt_.ambpath, ""},
    {"file-respath", 2, (void *)&filopt_.respath, ""},
    {"file-azlpath", 2, (void *)&filopt_.azlpath, ""},
    {"file-solstatpath", 2, (void *)&filopt_.solstatpath, ""},
    {"file-tracepath", 2, (void *)&filopt_.tracepath, ""},
...
static int str2enum(const char *str, const char *comment, int *val) {
  ...
  memcpy(s, s + i, (len - i) * sizeof(char));
  s[len - i] = '\0';
  chop(s);
...
/* option to string
 *------------------------------------------------------------- convert option
 *to string (keyword=value # comment) args   : opt_t  *opt      I  option char
 **buff     O  option string return : length of output string
 *-----------------------------------------------------------------------------*/
...
static void sysopts2buff(void) {
  ...
  exsats_[0] = '\0';
  for (sat = 1, p = exsats_;
       sat <= MAXSAT && p - exsats_ < (int)sizeof(exsats_) - 32; sat++) {
...
extern void resetsysopts(void) {
  ...
  filopt_.dcb[0] = '\0';
  filopt_.blq[0] = '\0';
  filopt_.solstatpath[0] = '\0';
  filopt_.tracepath[0] = '\0';
